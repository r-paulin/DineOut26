...
function SvgScoreOutlined(props) {
    return (React.createElement("svg", Object.assign({ width: sizes[props.size || "lg"], height: sizes[props.size || "lg"], viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React.createElement("path", { d: "M14.5 12C14.5 13.3807 13.3807 14.5 12 14.5C10.6193 14.5 9.5 13.3807 9.5 12C9.5 10.6193 10.6193 9.5 12 9.5C12.3224 9.5 12.6306 9.56104 12.9136 9.6722L15.5356 7.05025C15.9261 6.65973 16.5593 6.65973 16.9498 7.05025C17.3403 7.44078 17.3403 8.07394 16.9498 8.46447L14.3278 11.0864C14.439 11.3694 14.5 11.6776 14.5 12Z", fill: "currentColor" }),

...
function SvgAddressPickup(props) {
    return (React.createElement("svg", Object.assign({ width: sizes[props.size || "lg"], height: sizes[props.size || "lg"], viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React.createElement("circle", { cx: 12, cy: 12, r: 10.5, fill: "#007042", fillOpacity: 0.92, stroke: "white", strokeWidth: 3, strokeLinejoin: "round" }),
        React.createElement("circle", { cx: 12, cy: 12, r: 3, fill: "white" })));
}
export default SvgAddressPickup;

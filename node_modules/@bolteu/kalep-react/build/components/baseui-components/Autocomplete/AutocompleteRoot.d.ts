 ...
 * ```
 */
export declare function AutocompleteRoot<Items>(props: BaseUIAutocomplete.Root.Props<Items> & AutocompleteRootCustomProps): React.JSX.Element;
export {};
//# sourceMappingURL=AutocompleteRoot.d.ts.map
 ...
 * ```
 */
export declare function ComboboxRoot<ItemValue, Multiple extends boolean | undefined = false>(props: BaseUICombobox.Root.Props<ItemValue, Multiple> & ComboboxRootCustomProps): React.JSX.Element;
export {};

...
const multilineOptions = [multilineOption, ...cityOptions];
const secondaryItems = [{
  label: "Tallinn",
  value: "1",
  secondary: "Capital of Estonia"
}, {
  label: "Stockholm",
  value: "2",
  secondary: "Capital of Sweden"
}, {
  label: "Berlin",
  value: "3",
  secondary: "Capital of Germany"
}, {
  label: "Warsaw",
  value: "4",
  secondary: "Capital of Poland"
}, {
  label: "Paris",
  value: "5",
  secondary: "Capital of France"
}, {
  label: "London",
  value: "6",
  ...
  label: "Lisbon",
  value: "7",
  secondary: "Capital of Portugal"
}, {
  label: "Johannesburg",
  value: "8",
  secondary: "Capital of South Africa"
}];
...
function BaseUISelectPreview({
  ...
  const getElementTestId = React.useCallback(part => testId ? `${testId}-${part}` : undefined, [testId]);
  return /*#__PURE__*/React.createElement(Form, errorMessage ? {
    errors: {
      [`select-${label}`]: errorMessage
    }
  } : {}, /*#__PURE__*/React.createElement("div", {
    className: "max-w-96"
  }, /*#__PURE__*/React.createElement(Field.Root, {
    name: `select-${label}`,
    disabled: disabled,
    invalid: Boolean(errorMessage)
  }, /*#__PURE__*/React.createElement(Field.Label, null, label), /*#__PURE__*/React.createElement(Select.Root, _extends({
    items: options,
    size: size,
    multiline: multiline,
    disabled: disabled,
    ...
    defaultValue: null
  }, selectionProps), /*#__PURE__*/React.createElement(Select.Trigger, {
    "data-testid": getElementTestId("trigger")
  }, /*#__PURE__*/React.createElement(Select.Value, {
    "data-testid": getElementTestId("value")
  }), /*#__PURE__*/React.createElement(Select.Icon, null)), /*#__PURE__*/React.createElement(Select.Portal, null, /*#__PURE__*/React.createElement(Select.Positioner, null, /*#__PURE__*/React.createElement(Select.Popup, null, /*#__PURE__*/React.createElement(Select.List, {
    "data-testid": getElementTestId("list")
  }, options.map(option => /*#__PURE__*/React.createElement(Select.Item, {
    key: option.value ?? "placeholder",
    value: option.value,
    "data-testid": option.value === null ? getElementTestId("item-null") : getElementTestId(`item-${option.value}`)
  }, option.secondary ? /*#__PURE__*/React.createElement("div", {
    className: "flex min-w-0 flex-1 flex-col"
  }, /*#__PURE__*/React.createElement(Select.ItemText, null, option.label), /*#__PURE__*/React.createElement("span", {
    className: "bolt-font-body-s-regular m-0 text-secondary"
  }, option.secondary)) : /*#__PURE__*/React.createElement(Select.ItemText, null, option.label), /*#__PURE__*/React.createElement(Select.ItemIndicator, null)))))))), /*#__PURE__*/React.createElement(Field.Error, null))));
}
...
export const Playground = {
  render: args => {
    ...
    if (isMultiple) {
      return /*#__PURE__*/React.createElement("div", {
        className: "max-w-96"
      }, /*#__PURE__*/React.createElement(Field.Root, null, /*#__PURE__*/React.createElement(Field.Label, null, "Label"), /*#__PURE__*/React.createElement(Select.Root, _extends({
        multiple: true,
        items: cityItems,
        value: multiValue,
        onValueChange: setMultiValue
      }, restArgs), /*#__PURE__*/React.createElement(Select.Trigger, null, /*#__PURE__*/React.createElement(Select.Value, {
        placeholder: "Placeholder"
      }), /*#__PURE__*/React.createElement(Select.Icon, null)), /*#__PURE__*/React.createElement(Select.Portal, null, /*#__PURE__*/React.createElement(Select.Positioner, null, /*#__PURE__*/React.createElement(Select.Popup, null, /*#__PURE__*/React.createElement(Select.List, null, cityItems.map(option => /*#__PURE__*/React.createElement(Select.Item, {
        key: option.value,
        value: option.value
      }, /*#__PURE__*/React.createElement(Select.ItemText, null, option.label), /*#__PURE__*/React.createElement(Select.ItemIndicator, null))))))))));
    }
    return /*#__PURE__*/React.createElement("div", {
      className: "max-w-96"
    }, /*#__PURE__*/React.createElement(Field.Root, null, /*#__PURE__*/React.createElement(Field.Label, null, "Label"), /*#__PURE__*/React.createElement(Select.Root, _extends({
      ...
      placeholder: "Placeholder"
    }), /*#__PURE__*/React.createElement(Select.Icon, null)), /*#__PURE__*/React.createElement(Select.Portal, null, /*#__PURE__*/React.createElement(Select.Positioner, null, /*#__PURE__*/React.createElement(Select.Popup, null, /*#__PURE__*/React.createElement(Select.List, null, cityOptions.map(option => /*#__PURE__*/React.createElement(Select.Item, {
  ...
  argTypes: {
    multiple: {
      control: "boolean",
      description: "Enable multi-value selection mode. When true, `value` is `Value[]` and the trigger shows all selected labels joined by commas."
    },
    disabled: {
      control: "boolean"
    },
...
export const Default = {
  render: () => /*#__PURE__*/React.createElement(BaseUISelectPreview, {
    placeholder: "Placeholder",
  ...
  play: async ({
    ...
    await step("Opens popup and selects Berlin", async () => {
      ...
      const list = await screen.findByTestId("select-default-list", {}, {
        timeout: 3000
      });
      const berlin = await within(list).findByRole("option", {
        name: /Berlin/i
      });
...
export const Sizes = {
  ...
  }, /*#__PURE__*/React.createElement(BaseUISelectPreview, {
    label: "Small",
    size: "sm",
    placeholder: "City",
    testId: "select-sizes-small"
  }), /*#__PURE__*/React.createElement(BaseUISelectPreview, {
    label: "Medium (default)",
    placeholder: "City",
    testId: "select-sizes-medium"
  }), /*#__PURE__*/React.createElement(BaseUISelectPreview, {
    label: "Large",
    size: "lg",
    placeholder: "City",
    testId: "select-sizes-large"
  })),
  play: async ({
    canvas,
    step
    ...
    await step("Medium select opens and updates value", async () => {
      ...
      const list = await screen.findByTestId("select-sizes-medium-list", {}, {
        timeout: 3000
      });
...
export const Multiline = {
  ...
  play: async ({
    ...
    await step("Popup shows multiline option", async () => {
      await userEvent.click(trigger);
      const popup = await screen.findByTestId("select-multiline-list", {}, {
        timeout: 3000
      });
      const {
        findByText
...
export const Error = {
  render: () => /*#__PURE__*/React.createElement(BaseUISelectPreview, {
    errorMessage: "Please pick a valid city",
    defaultValue: null,
    testId: "select-error"
  }),
  play: async ({
...
export const ReadonlyMultiple = {
  render: () => /*#__PURE__*/React.createElement("div", {
    ...
    className: "max-w-96"
  }, /*#__PURE__*/React.createElement(Field.Root, null, /*#__PURE__*/React.createElement(Field.Label, null, "Readonly multi (all 8 selected \u2014 sm)"), /*#__PURE__*/React.createElement(Select.Root, {
    multiple: true,
    items: cityItems,
    size: "sm",
    readOnly: true,
    ...
    "data-testid": "readonly-multi-sm-trigger"
  }, /*#__PURE__*/React.createElement(Select.Value, {
    "data-testid": "readonly-multi-sm-value"
  }), /*#__PURE__*/React.createElement(Select.Icon, null)), /*#__PURE__*/React.createElement(Select.Portal, null, /*#__PURE__*/React.createElement(Select.Positioner, null, /*#__PURE__*/React.createElement(Select.Popup, null, /*#__PURE__*/React.createElement(Select.List, null, cityItems.map(option => /*#__PURE__*/React.createElement(Select.Item, {
    key: option.value,
    value: option.value
  }, /*#__PURE__*/React.createElement(Select.ItemText, null, option.label), /*#__PURE__*/React.createElement(Select.ItemIndicator, null)))))))))), /*#__PURE__*/React.createElement("div", {
    className: "max-w-96"
  }, /*#__PURE__*/React.createElement(Field.Root, null, /*#__PURE__*/React.createElement(Field.Label, null, "Readonly multi (all 8 selected \u2014 md)"), /*#__PURE__*/React.createElement(Select.Root, {
    multiple: true,
    items: cityItems,
    readOnly: true,
    defaultValue: cityItems.map(c => c.value)
  }, /*#__PURE__*/React.createElement(Select.Trigger, {
    "data-testid": "readonly-multi-md-trigger"
  }, /*#__PURE__*/React.createElement(Select.Value, {
    "data-testid": "readonly-multi-md-value"
  }), /*#__PURE__*/React.createElement(Select.Icon, null)), /*#__PURE__*/React.createElement(Select.Portal, null, /*#__PURE__*/React.createElement(Select.Positioner, null, /*#__PURE__*/React.createElement(Select.Popup, null, /*#__PURE__*/React.createElement(Select.List, null, cityItems.map(option => /*#__PURE__*/React.createElement(Select.Item, {
    key: option.value,
    value: option.value
  }, /*#__PURE__*/React.createElement(Select.ItemText, null, option.label), /*#__PURE__*/React.createElement(Select.ItemIndicator, null)))))))))), /*#__PURE__*/React.createElement("div", {
    className: "max-w-96"
  }, /*#__PURE__*/React.createElement(Field.Root, null, /*#__PURE__*/React.createElement(Field.Label, null, "Readonly multi (all 8 selected \u2014 lg)"), /*#__PURE__*/React.createElement(Select.Root, {
    multiple: true,
    items: cityItems,
    size: "lg",
    readOnly: true,
    ...
    "data-testid": "readonly-multi-lg-trigger"
  }, /*#__PURE__*/React.createElement(Select.Value, {
    "data-testid": "readonly-multi-lg-value"
  }), /*#__PURE__*/React.createElement(Select.Icon, null)), /*#__PURE__*/React.createElement(Select.Portal, null, /*#__PURE__*/React.createElement(Select.Positioner, null, /*#__PURE__*/React.createElement(Select.Popup, null, /*#__PURE__*/React.createElement(Select.List, null, cityItems.map(option => /*#__PURE__*/React.createElement(Select.Item, {
    key: option.value,
    value: option.value
  }, /*#__PURE__*/React.createElement(Select.ItemText, null, option.label), /*#__PURE__*/React.createElement(Select.ItemIndicator, null))))))))))),
 ...
 */
export const ReadonlyMultipleFewValues = {
  render: () => /*#__PURE__*/React.createElement("div", {
    className: "max-w-96"
  }, /*#__PURE__*/React.createElement(Field.Root, null, /*#__PURE__*/React.createElement(Field.Label, null, "Readonly multi (2 selected)"), /*#__PURE__*/React.createElement(Select.Root, {
    multiple: true,
    items: cityItems,
    readOnly: true,
    defaultValue: [cityItems[0].value, cityItems[2].value]
  }, /*#__PURE__*/React.createElement(Select.Trigger, {
    "data-testid": "readonly-multi-few-trigger"
  }, /*#__PURE__*/React.createElement(Select.Value, {
    "data-testid": "readonly-multi-few-value"
  }), /*#__PURE__*/React.createElement(Select.Icon, null)), /*#__PURE__*/React.createElement(Select.Portal, null, /*#__PURE__*/React.createElement(Select.Positioner, null, /*#__PURE__*/React.createElement(Select.Popup, null, /*#__PURE__*/React.createElement(Select.List, null, cityItems.map(option => /*#__PURE__*/React.createElement(Select.Item, {
    key: option.value,
    value: option.value
  }, /*#__PURE__*/React.createElement(Select.ItemText, null, option.label), /*#__PURE__*/React.createElement(Select.ItemIndicator, null)))))))))),
...
export const Controlled = {
  render: () => {
    const [value, setValue] = React.useState(cityItems[0].value);
    const selectedLabel = cityItems.find(option => option.value === value)?.label;
    const helperMessage = selectedLabel ? `${selectedLabel} has been picked` : "Pick something to see this text change";
    const handleControlledValueChange = React.useCallback(nextValue => {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "bolt-font-body-s-regular text-secondary"
    }, helperMessage));
  },
  play: async ({
    canvas,
    ...
    await step("Selecting another value updates helper text", async () => {
      ...
      const helper = await canvas.findByText(/has been picked/i);
      await userEvent.click(trigger);
      const list = await screen.findByTestId("select-controlled-list", {}, {
        timeout: 3000
      });
...
export const SecondaryDescription = {
  ...
  play: async ({
    ...
    await step("Descriptions are rendered in the popup", async () => {
      ...
      await userEvent.click(trigger);
      const list = await screen.findByTestId("select-secondary-list", {}, {
        timeout: 3000
      });
      const description = await within(list).findByRole("option", {
        name: /Tallinn/i
      });
 ...
 */
export const MultipleSelectBasic = {
  render: () => {
    const [value, setValue] = React.useState(["1", "3"]);
    return /*#__PURE__*/React.createElement("div", {
      className: "max-w-96"
    }, /*#__PURE__*/React.createElement(Field.Root, null, /*#__PURE__*/React.createElement(Field.Label, null, "Select cities"), /*#__PURE__*/React.createElement(Select.Root, {
      multiple: true,
      items: cityItems,
      value: value,
      onValueChange: setValue
    }, /*#__PURE__*/React.createElement(Select.Trigger, {
      "data-testid": "multi-basic-trigger"
    }, /*#__PURE__*/React.createElement(Select.Value, {
      placeholder: "Select cities...",
      "data-testid": "multi-basic-value"
    }), /*#__PURE__*/React.createElement(Select.Icon, null)), /*#__PURE__*/React.createElement(Select.Portal, null, /*#__PURE__*/React.createElement(Select.Positioner, null, /*#__PURE__*/React.createElement(Select.Popup, null, /*#__PURE__*/React.createElement(Select.List, {
      "data-testid": "multi-basic-list"
    }, cityItems.map(option => /*#__PURE__*/React.createElement(Select.Item, {
      key: option.value,
      value: option.value
    }, /*#__PURE__*/React.createElement(Select.ItemText, null, option.label), /*#__PURE__*/React.createElement(Select.ItemIndicator, null))))))))), /*#__PURE__*/React.createElement("div", {
  ...
  play: async ({
    ...
    await step("Dropdown opens on trigger click", async () => {
      ...
      await userEvent.click(trigger);
      const list = await screen.findByTestId("multi-basic-list", {}, {
        timeout: 3000
      });
 ...
 */
export const MultipleSelectManyValues = {
  render: () => {
    const [value, setValue] = React.useState(["1", "2", "3", "4", "5"]);
    return /*#__PURE__*/React.createElement("div", {
      className: "max-w-96"
    }, /*#__PURE__*/React.createElement(Field.Root, null, /*#__PURE__*/React.createElement(Field.Label, null, "Select cities (5 selected)"), /*#__PURE__*/React.createElement(Select.Root, {
      multiple: true,
      items: cityItems,
      value: value,
      onValueChange: setValue
    }, /*#__PURE__*/React.createElement(Select.Trigger, null, /*#__PURE__*/React.createElement(Select.Value, {
      placeholder: "Select cities..."
    }), /*#__PURE__*/React.createElement(Select.Icon, null)), /*#__PURE__*/React.createElement(Select.Portal, null, /*#__PURE__*/React.createElement(Select.Positioner, null, /*#__PURE__*/React.createElement(Select.Popup, null, /*#__PURE__*/React.createElement(Select.List, null, cityItems.map(option => /*#__PURE__*/React.createElement(Select.Item, {
      key: option.value,
      value: option.value
...
export const MultipleSelectControlled = {
  render: () => {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, /*#__PURE__*/React.createElement(Field.Root, null, /*#__PURE__*/React.createElement(Field.Label, null, "Select cities (controlled)"), /*#__PURE__*/React.createElement(Select.Root, {
      multiple: true,
      items: cityItems,
      value: value,
      onValueChange: setValue,
      ...
      key: option.value,
      value: option.value
    }, /*#__PURE__*/React.createElement(Select.ItemText, null, option.label), /*#__PURE__*/React.createElement(Select.ItemIndicator, null))))))))), /*#__PURE__*/React.createElement("p", {
      className: "bolt-font-body-s-regular text-secondary"
    }, selectedLabels.length === 0 ? "Nothing selected yet." : `Selected: ${selectedLabels.join(", ")}`), /*#__PURE__*/React.createElement("div", {
 ...
 */
export const MultipleSelectWithSecondaryText = {
  render: () => {
    const [value, setValue] = React.useState(["1", "3"]);
    return /*#__PURE__*/React.createElement("div", {
      className: "max-w-96"
      ...
      placeholder: "Select cities..."
    }), /*#__PURE__*/React.createElement(Select.Icon, null)), /*#__PURE__*/React.createElement(Select.Portal, null, /*#__PURE__*/React.createElement(Select.Positioner, null, /*#__PURE__*/React.createElement(Select.Popup, null, /*#__PURE__*/React.createElement(Select.List, null, secondaryItems.map(option => /*#__PURE__*/React.createElement(Select.Item, {
      key: option.value,
      value: option.value
    }, /*#__PURE__*/React.createElement("div", {
      className: "flex min-w-0 flex-1 flex-col"
    }, /*#__PURE__*/React.createElement(Select.ItemText, null, option.label), option.secondary && /*#__PURE__*/React.createElement("span", {
      className: "bolt-font-body-s-regular m-0 text-secondary"
    }, option.secondary)), /*#__PURE__*/React.createElement(Select.ItemIndicator, null))))))))));
  },
 ...
 * can be opened.
 */
export const MultipleSelectDisabled = {
  render: () => /*#__PURE__*/React.createElement("div", {
    className: "flex max-w-96 flex-col gap-6"
  }, /*#__PURE__*/React.createElement(Field.Root, {
    disabled: true
  }, /*#__PURE__*/React.createElement(Field.Label, null, "Select cities (disabled, nothing selected)"), /*#__PURE__*/React.createElement(Select.Root, {
    multiple: true,
    items: cityItems,
    disabled: true,
    defaultValue: []
    ...
    key: option.value,
    value: option.value
  }, /*#__PURE__*/React.createElement(Select.ItemText, null, option.label), /*#__PURE__*/React.createElement(Select.ItemIndicator, null))))))))), /*#__PURE__*/React.createElement(Field.Root, {
    disabled: true
  }, /*#__PURE__*/React.createElement(Field.Label, null, "Select cities (disabled, with pre-selections)"), /*#__PURE__*/React.createElement(Select.Root, {
    multiple: true,
    items: cityItems,
    disabled: true,
    defaultValue: ["1", "3", "5"]
 ...
 */
export const MultipleSelectWithCheckboxes = {
  render: () => {
    const [value, setValue] = React.useState(["1", "3"]);
    return /*#__PURE__*/React.createElement("div", {
      className: "max-w-96"
      ...
      key: option.value,
      value: option.value
    }, /*#__PURE__*/React.createElement(Select.CheckboxIndicator, null), /*#__PURE__*/React.createElement(Select.ItemText, null, option.label))))))))));
  },
...
const cityItemToStringLabel = value => value.name;

/** Converts a City value to its IATA code for form submission. */
const cityItemToStringValue = value => value.code;

/** Matches cities by numeric id — not by object reference. */
const cityIsItemEqualToValue = (item, value) => item.id === value.id;
function SemanticSelectShell({
  children,
  testId
}) {
  return /*#__PURE__*/React.createElement("div", {
    className: "max-w-96",
    "data-testid": testId
  }, /*#__PURE__*/React.createElement(Field.Root, null, /*#__PURE__*/React.createElement(Field.Label, null, "Select a city"), children));
}
function CityItemList() {
  return /*#__PURE__*/React.createElement(React.Fragment, null, cityObjectItems.map(city => /*#__PURE__*/React.createElement(Select.Item, {
    key: city.id,
    value: city
  }, /*#__PURE__*/React.createElement(Select.ItemText, null, city.name), /*#__PURE__*/React.createElement(Select.ItemIndicator, null))));
}
...
`;
export const ObjectValuesWithItemToStringLabel = {
  render: () => {
    const [value, setValue] = React.useState(null);
    return /*#__PURE__*/React.createElement(SemanticSelectShell, {
      testId: "semantic-label"
    }, /*#__PURE__*/React.createElement(Select.Root, {
      value: value,
      onValueChange: setValue,
      itemToStringLabel: cityItemToStringLabel
    }, /*#__PURE__*/React.createElement(Select.Trigger, {
      "data-testid": "semantic-label-trigger"
    }, /*#__PURE__*/React.createElement(Select.Value, {
      placeholder: "Select a city...",
      "data-testid": "semantic-label-value"
    }), /*#__PURE__*/React.createElement(Select.Icon, null)), /*#__PURE__*/React.createElement(Select.Portal, null, /*#__PURE__*/React.createElement(Select.Positioner, null, /*#__PURE__*/React.createElement(Select.Popup, null, /*#__PURE__*/React.createElement(Select.List, {
      "data-testid": "semantic-label-list"
    }, /*#__PURE__*/React.createElement(CityItemList, null)))))));
  },
  parameters: {
    docs: {
      source: {
        code: objectValuesWithItemToStringLabelStorySource.trim()
      },
      description: {
        story: "Use `itemToStringLabel` when item values are objects without a `.label` property. " + "The function converts the object to a display string for the trigger."
      }
    }
  },
  play: async ({
    ...
    await step("Opening and selecting Berlin", async () => {
      ...
      await userEvent.click(trigger);
      const list = await screen.findByTestId("semantic-label-list", {}, {
        timeout: 3000
      });
      const berlin = await within(list).findByText("Berlin");
      await userEvent.click(berlin);
      await waitFor(() => expect(screen.queryByTestId("semantic-label-list")).not.toBeVisible(), {
        timeout: 3000
      });
    });
...
`;
export const ControlledWithIsItemEqualToValue = {
  render: () => {
    // Start with a reference to the actual item object
    const [value, setValue] = React.useState(cityObjectItems[0]);
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: "flex max-w-96 flex-col gap-4"
    }, /*#__PURE__*/React.createElement(SemanticSelectShell, {
      testId: "semantic-eq"
    }, /*#__PURE__*/React.createElement(Select.Root, {
      value: value,
      onValueChange: setValue,
      ...
      "data-testid": "semantic-eq-trigger"
    }, /*#__PURE__*/React.createElement(Select.Value, {
      placeholder: "Select a city...",
      "data-testid": "semantic-eq-value"
    }), /*#__PURE__*/React.createElement(Select.Icon, null)), /*#__PURE__*/React.createElement(Select.Portal, null, /*#__PURE__*/React.createElement(Select.Positioner, null, /*#__PURE__*/React.createElement(Select.Popup, null, /*#__PURE__*/React.createElement(Select.List, {
      "data-testid": "semantic-eq-list"
    }, /*#__PURE__*/React.createElement(CityItemList, null))))))), /*#__PURE__*/React.createElement("button", {
      type: "button",
    ...
    }, "Reassign value (new object reference, same id)"), /*#__PURE__*/React.createElement("p", {
      className: "bolt-font-body-s-regular text-secondary"
  ...
  parameters: {
    docs: {
      source: {
        code: controlledWithIsItemEqualToValueStorySource.trim()
      },
      description: {
        story: "Use `isItemEqualToValue` when value objects are not stable references " + "(e.g. reconstructed from API responses). The comparator matches by identity field " + "instead of `Object.is`, keeping the correct item highlighted."
      }
    }
  },
  play: async ({
    ...
    await step("Opening dropdown — Tallinn item is marked selected", async () => {
      ...
      await userEvent.click(trigger);
      const list = await screen.findByTestId("semantic-eq-list", {}, {
        timeout: 3000
      });
      const tallinnOption = await within(list).findByRole("option", {
        name: /Tallinn/i
      });
...
`;
export const MultiSelectObjectValues = {
  render: () => {
    const [value, setValue] = React.useState([cityObjectItems[0], cityObjectItems[2]]);
    return /*#__PURE__*/React.createElement("div", {
      className: "flex max-w-96 flex-col gap-4"
    }, /*#__PURE__*/React.createElement(Field.Root, null, /*#__PURE__*/React.createElement(Field.Label, null, "Select cities"), /*#__PURE__*/React.createElement(Select.Root, {
      multiple: true,
      ...
      "data-testid": "semantic-multi-trigger"
    }, /*#__PURE__*/React.createElement(Select.Value, {
      placeholder: "Select cities...",
      "data-testid": "semantic-multi-value"
    }), /*#__PURE__*/React.createElement(Select.Icon, null)), /*#__PURE__*/React.createElement(Select.Portal, null, /*#__PURE__*/React.createElement(Select.Positioner, null, /*#__PURE__*/React.createElement(Select.Popup, null, /*#__PURE__*/React.createElement(Select.List, {
      "data-testid": "semantic-multi-list"
    }, cityObjectItems.map(city => /*#__PURE__*/React.createElement(Select.Item, {
      key: city.id,
      value: city
    }, /*#__PURE__*/React.createElement(Select.ItemText, null, city.name), /*#__PURE__*/React.createElement(Select.ItemIndicator, null))))))))), /*#__PURE__*/React.createElement("p", {
      className: "bolt-font-body-s-regular text-secondary"
  ...
  parameters: {
    docs: {
      source: {
        code: multiSelectObjectValuesStorySource.trim()
      },
      description: {
        story: "Multi-select with object values. `itemToStringLabel` drives the trigger " + "display (all selected labels joined by commas). `isItemEqualToValue` ensures " + "items are correctly matched even when value references change."
      }
    }
  },
  play: async ({
    ...
    await step("Opening dropdown and selecting a third city (Warsaw)", async () => {
      ...
      await userEvent.click(trigger);
      const list = await screen.findByTestId("semantic-multi-list", {}, {
        timeout: 3000
      });
      const warsaw = await within(list).findByText("Warsaw");
      await userEvent.click(warsaw);
      await expect(list).toBeVisible();
      await userEvent.keyboard("{Escape}");
      await waitFor(() => expect(screen.queryByTestId("semantic-multi-list")).not.toBeVisible(), {
        timeout: 3000
      });
    });
...
export const AllSemanticProps = {
  render: () => {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      name: "city"
    }, /*#__PURE__*/React.createElement(Field.Label, null, "Select a city"), /*#__PURE__*/React.createElement(Select.Root, {
      value: value,
      onValueChange: setValue,
      name: "city",
      itemToStringLabel: cityItemToStringLabel,
      ...
      "data-testid": "semantic-all-trigger"
    }, /*#__PURE__*/React.createElement(Select.Value, {
      placeholder: "Select a city...",
      "data-testid": "semantic-all-value"
    }), /*#__PURE__*/React.createElement(Select.Icon, null)), /*#__PURE__*/React.createElement(Select.Portal, null, /*#__PURE__*/React.createElement(Select.Positioner, null, /*#__PURE__*/React.createElement(Select.Popup, null, /*#__PURE__*/React.createElement(Select.List, {
      "data-testid": "semantic-all-list"
    }, /*#__PURE__*/React.createElement(CityItemList, null))))))), value && /*#__PURE__*/React.createElement("p", {
      className: "bolt-font-body-s-regular text-secondary"
    }, "Display label: ", /*#__PURE__*/React.createElement("strong", null, cityItemToStringLabel(value)), " \u2014 Form value:", " ", /*#__PURE__*/React.createElement("strong", null, cityItemToStringValue(value))));
  },
  parameters: {
    docs: {
      source: {
        code: allSemanticPropsStorySource.trim()
      },
      description: {
        story: "Full configuration with all three semantic props. " + "`itemToStringLabel` drives display, `itemToStringValue` drives form submission " + "(the hidden input), and `isItemEqualToValue` handles object identity matching."
      }
    }
  },
  play: async ({
    ...
    await step("Opening dropdown and selecting Paris", async () => {
      ...
      await userEvent.click(trigger);
      const list = await screen.findByTestId("semantic-all-list", {}, {
        timeout: 3000
      });
      const paris = await within(list).findByText("Paris");
      await userEvent.click(paris);
      await waitFor(() => expect(screen.queryByTestId("semantic-all-list")).not.toBeVisible(), {
        timeout: 3000
      });
    });

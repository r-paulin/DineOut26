...
const PaginationStory = args => {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "h-[240px] p-3 text-primary"
  }, content[currentPage % content.length]), /*#__PURE__*/React.createElement(Pagination, _extends({}, args, {
    "aria-label": "Main pagination",
...
export const PerPageOptions = () => {
  ...
  const onPaginationClick = React.useCallback(page => {
    setCurrentPage(page);
  }, []);
  const onRowsPerPageChange = React.useCallback(rpp => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "grid w-full place-items-center bg-neutral-secondary p-6 text-primary"
  }, /*#__PURE__*/React.createElement("span", null, `Showing ${rowsPerPage * currentPage + 1}...${clamp(0, rowsPerPage * currentPage + rowsPerPage, totalItems)} of ${totalItems} rows.`), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", null, `You are on page ${currentPage + 1} of ${Math.ceil(totalItems / rowsPerPage)} pages.`)), /*#__PURE__*/React.createElement("footer", {
    className: `
  ...
  }), /*#__PURE__*/React.createElement(PaginationTotalCount, {
    currentPage: currentPage,
    rowsPerPage: rowsPerPage,
    totalItems: totalItems
  }), /*#__PURE__*/React.createElement(PaginationOptions, {
    value: rowsPerPage,

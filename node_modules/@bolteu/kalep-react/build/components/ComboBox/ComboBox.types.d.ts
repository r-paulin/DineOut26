...
import type { UseComboboxGetInputPropsOptions, UseComboboxGetInputPropsReturnValue, UseComboboxGetToggleButtonPropsOptions, UseComboboxGetToggleButtonPropsReturnValue, UseMultipleSelectionGetDropdownReturnValue } from "downshift";
...
export interface ComboBoxProps {
    ...
    filterOptions?: (options: SelectOption[], filterHelpers: {
        inputValue: string;
...
export interface ComboBoxTriggerProps {
    ...
    getOptionLabel: (option: SelectOption | null) => string;
    getToggleButtonProps: (options?: UseComboboxGetToggleButtonPropsOptions) => UseComboboxGetToggleButtonPropsReturnValue;
    id?: string;
    inputValue: string;

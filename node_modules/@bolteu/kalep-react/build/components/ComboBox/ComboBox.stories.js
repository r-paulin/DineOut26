...
const options = [{
  ...
  title: "El Pueblo de Nuestra Señora la Reina de los Ángeles del Río de Porciúncula",
  value: "losangeles"
}];
const virtualisedOptions = [];
for (let i = 0; i < 1000; i++) {
  virtualisedOptions.push({
    title: `Item ${i}`,
    value: `value-${i}`,
    secondary: `Description of item ${i}`
  });
}
const Template = args => /*#__PURE__*/React.createElement(ComboBox, args);
...
export const Sizes = () => /*#__PURE__*/React.createElement("div", {
...
}, "Single"), /*#__PURE__*/React.createElement(ComboBox, {
  helperText: "Pick anything",
  label: "Small",
  options: options,
  size: "sm",
  placeholder: "City"
  ...
  className: "my-4 h-[1px] bg-neutral-secondary"
}), /*#__PURE__*/React.createElement(Typography, {
  variant: "title-secondary"
}, "Multiple"), /*#__PURE__*/React.createElement(ComboBox, {
  helperText: "Pick anything",
  label: "Small",
  options: options,
  size: "sm",
...
StartSlot.args = {
  ...Default.args,
  renderStartSlot: () => /*#__PURE__*/React.createElement(Search, {
    size: "lg"
  })
};
...
EndSlot.args = {
  ...Default.args,
  renderEndSlot: () => /*#__PURE__*/React.createElement(Search, {
    size: "lg"
  })
};
...
const modifiedOptions = options.map((option, i) => i % 4 !== 0 ? option : {
  ...option,
  disabled: true
});
DisabledItems.args = {
...
export const Controlled = args => {
  ...
  return /*#__PURE__*/React.createElement(ComboBox, _extends({}, args, {
    onChange: handleChange,
    value: value,
    helperText: value ? `${value.title} has been picked` : "Pick something to see this text change"
  }));
};
export const ControlledMultiple = args => {
  const [value, setValue] = React.useState([]);
  const handleChange = React.useCallback(newValue => setValue(Array.isArray(newValue) ? newValue : []), []);
  return /*#__PURE__*/React.createElement(ComboBox, _extends({}, args, {
    options: options,
    ...
    value: value,
    noResultsMessage: "No city found",
    helperText: value.length ? `${value.map(item => item.title).join(", ")} have been been picked` : "Pick something to see this text change"
  }));
};
Controlled.args = {
  ...Default.args
...
const optionsWithSecondaryDescription = [{
  title: "Tallinn",
  value: "tallinn",
  ...
  title: "Prague",
  value: "prague",
  secondary: "Capital of Czechia"
}, {
  title: "Milan",
  value: "milan",
  secondary: "Definitely not capital of Italy 👀"
}, {
  title: "Rome",
  value: "rome",
  secondary: "Capital of Italy"
}, {
  title: "Paris",
  value: "paris",
...
export const CustomOptionRenderer = () => {
  const renderOption = React.useCallback(props => /*#__PURE__*/React.createElement("li", _extends({
    onClick: props.onClick,
    className: cx(`
                      cursor-pointer px-4 py-3 text-base
                      hover:bg-promo-secondary
                    `, props.selected && "font-semibold")
  }, props), props.selected && "👉 ", props.option.title), []);
...
CustomOverlayFooter.args = {
  ...Default.args,
  renderOverlayFooter: () => /*#__PURE__*/React.createElement("div", {
    className: "p-2 text-center text-xs text-secondary"
  }, "\xA9 OpenStreetMap")
};
...
export const FullWidth = () => /*#__PURE__*/React.createElement(Grid, {
  columns: 15,
  alignItems: "flex-end"
  ...
  options: [{
    ...
    value: "maybe",
    title: "Also yes, but less likely"
  }],
  fullWidth: true,
  ...
  options: [{
    ...
    value: "maybe",
    title: "Also yes, but less likely. By default this makes it go wide."
  }],
  fullWidth: true,
  label: "Is inactive"
})));
...
export const OverlayConfiguration = () => /*#__PURE__*/React.createElement(Grid, {
  columns: 12
}, /*#__PURE__*/React.createElement(Grid.Item, {
  colSpan: 1
}, /*#__PURE__*/React.createElement(ComboBox, {
  ...
  visible: "HIDDEN_LEAVE_HOLE"
}, "\uD83E\uDD37\u200D\u2642\uFE0F"), /*#__PURE__*/React.createElement(Grid.Item, {
  colSpan: 2
}, /*#__PURE__*/React.createElement(ComboBox, {
  options: optionsWithSecondaryDescription,
  label: "City",
...
const testOptions = [...options, {
  title: "Delivery Courier Administration",
  value: "foo"
}, {
  title: "taxify_delivery_eater_campaign_targeting",
  value: "bar"
}];
export function AllWidths() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "mb-8 resize-x overflow-hidden border border-solid border-separator p-4"
  }, /*#__PURE__*/React.createElement(ComboBox, {
    options: testOptions,
    size: "md",
    multiple: true,
    ...
    className: "flex flex-col gap-8"
  }, widths.map((width, index) => /*#__PURE__*/React.createElement("div", {
    style: {
      width: `${width}px`
    },
    key: width
    ...
    fullWidth: true,
    placeholder: "e.g Tallinn",
    renderStartSlot: width > 200 ? () => /*#__PURE__*/React.createElement(Search, {
      size: index % 2 === 0 ? "sm" : "md"
    }) : undefined
  })))), /*#__PURE__*/React.createElement("div", {
    className: "flex flex-col gap-8"

 ...
 */
function createElement(element, classList = "", attributes = [], innerText = "") {
...
const PREBUILT_KALEP_STYLES = createElement("link", undefined, [["rel", "stylesheet"], ["href", "kalep.css"]]);
...
export const ResetInLayer = () => {
  ...
  React.useEffect(() => {
    const shadowRoot = rootRef.current?.attachShadow({
      mode: "open"
    });
    shadowRoot?.appendChild(createElement("style", undefined, undefined, `.button-style {background: ${RGB_HOTPINK};}`));
    shadowRoot?.appendChild(PREBUILT_KALEP_STYLES);
    shadowRoot?.appendChild(createElement("button", "button-style", [["type", "button"]], "This button should have a pink background"));
  }, []);
  return /*#__PURE__*/React.createElement("div", null, "This test will fail if the prebuilt ", /*#__PURE__*/React.createElement("code", null, "kalep.css"), " file does not have the reset styles wrapped in a layer.", /*#__PURE__*/React.createElement("main", {
    id: "TEST-ResetInLayer",
    ref: rootRef
  }));
};

...
export function PayBillSavedBadge({ savedAmountEur }: PayBillSavedBadgeProps) {
  ...
  return (
    <div className="relative mx-auto mt-4 flex h-[96px] w-[132px] shrink-0 items-center justify-center">
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
        ...
        >
          <img
            ...
            draggable={false}
          />
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-0.5 px-3 pt-0.5 text-center">
            <Typography
              variant="body-l-compact-regular"
              color="secondary"
              as="span"
              align="center"
            >
            ...
            <span
              className="m-0 block text-center text-primary"
              style={payBillSavedTicketAmountStyle}
            >

...
export const DINEOUT_STACKABLE_PAYMENT_PROMO_TEXT =
  "Enjoy 40% off your first 2 payments with DineOut" as const

/** Claim modal inline notification — primary line (Figma MODAL / Claiming offer). */
export const DINEOUT_CLAIM_INLINE_PRIMARY =
  "Save extra 40% on your first 2 DineOut payments" as const

/** Claim modal inline notification — secondary line. */
export const DINEOUT_CLAIM_INLINE_SECONDARY =
  "Valid for restaurant bill payments made in the app" as const

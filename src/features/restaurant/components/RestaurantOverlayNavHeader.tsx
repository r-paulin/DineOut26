...
/**
 * Figma Location nav `19444:49648` — 80px bar, 24px top pad, plain icon slots
 * (no circle chrome, no bottom divider). Center title fades in on scroll.
 */
const NAV_ICON_BTN =
...
export function RestaurantOverlayNavHeader({
  ...
  return (
    <header className="flex w-full shrink-0 flex-col bg-layer-floor-1 pt-[max(1.5rem,var(--safe-area-top))]">
      <div className="flex min-h-14 w-full items-center gap-4 px-6 pb-2">
        <button
          type="button"

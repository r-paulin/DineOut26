 ...
 *
 * **About** is an in-stack page over the main scroll (same shell as detail),
 * not a portaled modal — see `aboutOpen` / `aboutStackRef`.
 */
      ...
      >
        ...
        >
          <div
            ...
            style={{
              paddingBottom:
                "calc(max(1rem, var(--safe-area-bottom, 0px)) + 0.5rem)",
            }}
